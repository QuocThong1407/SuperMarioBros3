...
#define WINDOW_ICON_PATH L"assets/logos/mario.ico"

#define BACKGROUND_COLOR D3DXCOLOR(156.0f/255, 252.0f/255, 240.0f/255, 1.0f)

#define SCREEN_WIDTH 262
...
int WINAPI WinMain(
	...
	game->Load(L"assets/data/mario-sample.txt");  
